...
.plotPrositIntensity <- function(peptide,
  ...
  #precursorCharge = 3
  #collisionEnergy = 35
  p <- dlomix::prosit2019Intensity(peptide,
...
.CENormalization <- function(peptide = "DGLDAASYYAPVR",
  ...
  ps <- dlomix::prosit2019Intensity(peptides, collisionEnergy = collisionEnergies, precursorCharge =  precursorCharges) |>
...
```{r  eval=TRUE}
p <- dlomix::prosit2019Intensity(peptide = "LKEATIQLDELNQK",
                                 collisionEnergy = 35,
                                 precursorCharge = 3)[[1]]


L <- dlomix:::.composeSpecLibrary(peptide = "LKEATIQLDELNQK",
...
x <- dlomix::prosit2019Intensity(peptide = "GDLLQVM[UNIMOD:35]HEAFEK",
                                 collisionEnergy = 35,
                                 precursorCharge = 3)[[1]]

y <- dlomix::prosit2019Intensity(peptide = "GDLLQVMHEAFEK",
                                 collisionEnergy = 35,
                                 precursorCharge = 3)[[1]]
